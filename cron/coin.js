...
async function syncCoin() {
  ...
  const coin = new Coin({
    ...
    mnsOff: masternodes.grandtotal - masternodes.grandtotal,
    mnsOn: masternodes.grandtotal,
    rnOn: masternodes['total'][2]['count'],
    cnOn: masternodes['total'][1]['count'],
    snOn: masternodes['total'][0]['count'],
    netHash: nethashps,
