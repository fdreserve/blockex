...
const cncoins = 10000.0;

const rncoins = 50000.0;
...
//const getSnSubsidy = getSubsidy(nHeight);

//const getCnodeSubsidy = getCnSubsidy(nHeight);

//const getRnodeSubsidy = getRnSubsidy(nHeight);
