      ...
      <div className="footer">
        <div className="footer__block">
          ...
          <span className="footer__legal">
            ...
            <div>Fdreserve Explorer &copy; 2018 - {currentYear} <a href="https://www.fdreserve.com/" target="_blank" rel="nofollow noopener">French Digital Reserve</a></div>
          </span>
        </div>
        <div className="footer__block">
        ...
        <div className="footer__block">
          <div className="footer__social-media-wrapper">
            ...
            <div>
              <a href="https://bitcointalk.org/index.php?topic=4930081" target="_blank" rel="nofollow noopener">
                <Icon name="bitcoin" className="fab footer__social-media-icon" />
              </a>
              <a href="https://discord.com/invite/SzPexPp" target="_blank" rel="nofollow noopener">
                <Icon name="discord" className="fab footer__social-media-icon" />
              </a>
              <a href="https://t.me/FDR_Project_FR" target="_blank" rel="nofollow noopener">
                <Icon name="telegram" className="fab footer__social-media-icon" />
              </a>
              <a href="https://github.com/fdreserve" target="_blank" rel="nofollow noopener">
                <Icon name="github" className="fab footer__social-media-icon" />
              </a>
              <a href="https://twitter.com/FD_Reserve" target="_blank" rel="nofollow noopener">
