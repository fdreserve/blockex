...
.container .button {
  ...
  <body>
    <div class="logo">
      <a href="https://www.fdreserve.com/">
        <img src="https://www.fdreserve.com/wp-content/uploads/2021/02/fdr-logo-241x241-1.png" title="French Digital Reserve"/>
      </a>
      </div>
    <div class="container">
        <img src="https://media.giphy.com/media/vIDsZm5DMZ5Ha/giphy.gif" title="Sad Explorer."/>
      <h1>Maintenance</h1>
      <p>FDR Explorer is maintenance at this moment.<br/>Please check back later.</p><br/>
  <a href="https://blockbook.fdreserve.com/" class="button">go to blockbook explorer</a>
      </div>
  </body>
</html>
  `);
